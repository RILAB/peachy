...
% literature sources mostly deal with commercial/production lifespan
...
%
Fresh leaves and dormant cuttings collected from several sources (reference 1 in Table \ref{sampledetails}) and either desiccated with silica or refrigerated, respectively, followed by DNA isolation using a modified CTAB method \citep{doyle1987rapid}.
%
...
In-house sequencing library preparation first requires quantifying the samples using Quanti-iT Picogreen dsDNA assay (Invitrogen, Life Technologies) and then fragmenting 1 $\mu$g of DNA with a Bioruptor (Diagenode) for \X cycles of 30 seconds ON and 30 seconds OFF per cycle. 
%
Resulting DNA fragment ends were repaired with NEBNext End Repair (New England BioLabs) followed by the addition of deoxyadenosine triphosphate to the 3-prime ends using Klenow Fragment (New England BioLabs). 
%
Illumina TrueSeq barcoded adapters (Affymetrix) were added with the Quick Ligase Kit (New England BioLabs). 
%
Between each enzymatic step the DNA was washed with sera-mags speed beads(Fisher Scientific). 
%
...
% The resulting libraries were initially quantified with Qubit and sized with BioAnalyzer on a DNA HiSensitivity chip at UCD. 
%The libraries were then sent to UCB for qPCR quantification, pooling, and sequencing on a single lane of Illumina HiSeq 2000. 
...
\endlastfoot
%
	\emph{P. dulcis} &4 &7.76 &NCBI SRA &\citealt{koepke2013comparative}\\
	...
	\emph{P. persica} &10 &19.13 &NCBI SRA &\citealt{verde2013high} \\
	\emph{P. persica} &3 &13.78 &NCBI SRA &\citealt{ahmad2011whole} \\
...
% only domesticates and outgroup
...
%PD15 Nonpareil 0.99999999282605944728 0.00000000717394056482
% however, PD15 is same as other dulcis in previous test without PP12
%PP12 F8,1-42 0.00000000100000000000 0.99999999900000002828 (almond, peach; no different than rest of peaches) this seems odd for something with almond in pedigree only hmmmm...
%TBD - RUNNING...
%
...
%
% There is not nearly enough in this section...
% Add information about interesting loci, probably need a supplementary table
% Describe the most interesting, or those 
%
\section*{Discussion}
...
The only outcrossing wild peach species, \emph{P. davidiana}, is also considered closely affiliated %poor wording, more like an intermediate between persica and dulcis
...
% davidiana has highest pi of the wild peaches but is lower than dulcis
...
% except the possible life span difference, except P. mira has been reported to live ~100 years \citep{bassi20081} or chapter 2 of same book, seem to recall there was no citation for the number
%
...
One of the main questions regarding domestication of perennial crops, particularly tree crops, is its genetic basis \citep{miller2011forest}. %and distinguishing it from other factors such as life history, hybridization, vegetative propagation
%
