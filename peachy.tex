...
Peach \emph{P. persica} (Mill.) D. A. Webb and almond \emph{P. dulcis} (L.) Batsch are sibling species found within the subgenus \emph{Amigdalus}.
...
The most striking between the species are mature fruit morphology and mating systems: peaches are \X but almonds are \X. %worth explaining how fruits are related (almond is seed part peach is fleshy mesocarp etc.
But almond and peach also differ other traits, with almonds having \X life span, \X  chilling requirements, and less adventitious root generation.
