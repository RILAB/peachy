...
%
Utilizing the sequence of a previously identified F1 peach-almond hybrid and a peach variety with known almond ancestry in its pedigree three generations prior we evaluated proportion assignment accuracy. \jri{cool yes do that}
% RUNNING
%
...
%
Genomes resequenced in this study had an average depth of 22.40, ranging from 14.47 to 37.36, while public sequence depths averaged 7.92 and ranged from 1.14 to 35.40.
...
with P. dulcis, but has approximately 3X the nucleotide diversity of P. persica 
% how phylogenetically close?
