...
% increased size and morphological diversity of the harvested organ (seed, fruit, leaves, etc.)
% reduced seed dispersal
% adaptation to disturbed environments
% reduced toxicity, selfing, photoperiod insensitivity, etc. \citep{doebley2006molecular}
% only a few are noted in almond or peach
% 
%
...
%
%species within the subgenus \emph{Amygdalus} are both diploid
%genetic mapping of TxE $F_{2}$ population suggests similar genomic structure \citep{dirlewanger2004comparative}
%
%Peach
%230 Megabases (Mb)
%less than double the size of the \emph{Arabidopsis thaliana} genome
%eight chromosomes
%recently sequenced peach genome \citep{verde2013high}
%self-compatible
%serves as a model system for \emph{Prunus}
%relatively short generation time (seed to seed in 3 years)
%\citep{arus2012peach}.
%
%Almond
...
%
	...
	%not sure if this is correct reference for these samples
