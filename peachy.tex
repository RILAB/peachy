...
We treated peach and almond samples as two populations to understand population structure, assign population proportions to samples, and determine population differentiation using ANGSD and ngsTools' ngsPopGen programs.
%
First we performed a principal component analysis (PCA) to determine any underlying population structure.
%might show clear distinction between groups, possibly some overlap
Next we used ANGSD Admixture (\emph{K} = 2) to assign peach and/or almond population proportions to individuals. 
%
Proportion assignment accuracy was evaluated using the sequence of a likely F1 peach-almond hybrid and a peach variety of known pedigree containing almond three generations prior.
%
...
\section*{Results}
\emph{Quality Control and SNP Calling}\\
\\
%
\\
...
\\
Admixture - The individuals were clearly assigned to either peach or almond. 
%Probably save this for the results.
\\
%
\\
