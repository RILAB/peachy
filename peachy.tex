...
%
But almond and peach also differ at other traits, with almonds having a natural life span up to or exceeding 100 years,
...
400-600 hours chilling requirements \citep{alonso2005determination}, 
% versus peach <650-1050 /citep{dozier1990hydrogen}
and less adventitious root generation. 
%
...
%
Depth and alignment from SAMtools using depth and flagstat subprograms \citep{li2009sequence} determined a mean mapped sequence depth of 10.710, which ranged from 1.138 to 37.358 (supp. Figure \ref{fig:depth}).\\ %should separate out for our sequenced stuff and all else
...
%
\\
\emph{Peach and Almond Comparisons}\\
Analysis of peach and almond samples, treated as two populations, to understand population structure, population proportion assignment, and differentiation using ANGSD and ngsTools' ngsPopGen programs.\\
Principal component analysis (PCA) - covariate correlation to determine underlying population structure. \\ %might shows clear distinction between groups, possibly some overlap
Assignment of individuals as a proportion of peach and almond populations (\emph{K} = 2) using the ANGSD Admixture.\\ %
Examined population differentiation using F$_{ST}$ as determined by ANGSD.\\ 
%
\begin{center}
...
Nucleotide diversity (pi) was higher in almond than peach, with genome-wide means of 0.0186 and 0.0035, respectively. Mean per chromosome pi ranged from 0.0163 to 0.0219 in dulcis, and from 0.0028 to 0.0047 in persica.
\\
\\
%
