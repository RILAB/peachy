...
%worth explaining how fruits are related (almond is seed part peach is fleshy mesocarp etc.
%
...
%here X is just some time -- was it centuries later, millenia, rapidly, etc.
% hard to know, can give a range for peach intro to Persia, Greece, and more western Europe, but almond is less clear
% Persia first mention 332 BC by Theophrastus according to De Candolle (Alexander expansion into Persia)
% "did not reach Rome until after the beginning of the Christian era" Hedrick 1917
% Romans: no mention by Cato (201 BC) nor Varro (117-27 BC) but Pliny (79 AD) "expressly states that the peach was imported  by the Romans from Persia not long before" Hedrick 1917; also seems to have been known in France and possibly Asia Minor/Turkey at this time
% "Botany and history are a hard team to drive but when the two do travel together in determining the origin of a plant the matter, as a rule, is settled" Hedrick 1917
% Hedrick quotes wild peach collection notes of Meyer (accessions 40001-40005), pp 4-5
% SOURCE SEARCH: Cibot, Pierre Martial. 1777. Mem. concernant l'hist. les sciences etc. de Chinois. Hedrick states has chapter devoted to peach
%Hedrick p32: peach in France, four references used by Leroy wer Bishop Fortunat of Protiers (530), 14th Abbot of Saint-Deni (784), Charlemagne (800), Lupus, Abbot of Ferrieres (860); although see Pliny about French peaches
%Hedrick continues with history of peaches in other European countries (p33+)
%not suited to England, but English still managed to grow some "on walls or under glass", suggests peaches arrived with Romans, but disappeared and was reintroduced in 13th century
%"Perhaps it suffices to say that the peach began to be cultivated in England at the close of the Middle Ages - a time sufficiently vague to be convenient in the state of inexacness of our knowledge." Hedrick p35
%peaches first arrived in the Americas via Spain p34
%"Indian peaches of the southern forests" p39
%"Long before the English, Dutch, French or Swedes planted colonies in America, peaches, introduced by Spaniards, were common property of the Indians in southeastern and southwestern America" p 39
%"The Spaniards.. brought swords more often than fruits, but a cheery note in the long dirge of human woes suffered by the Aztecs is found in the rapid dissemination of the peach.. at an early period of Mexico" pp39-40
%"less than fifty years after Cortez conquered the country the peach was, apparently, commonly grown in Mexico"
%"in a comparatiely short time they had been taken northward into New Mexico, Arizona and the Californias. It is barely possible that from the same source the peach was eventually carried as far eastward as the Mississippi, for early explorers found naturalized peaches in the valley of this great river." pp40-41
%suspects arrived with Catholic missionaries in SW USA
%"the name of the peach is the radical while that of several plums is the equivalent of "little peach", "deer's peach" and "barren peach" while the cultivated apples and pears were by some Indians called "big peach"" p41
%"Indian Peach" types in SE/E USA
%SE USA peaches from Spanish settlements/explorers in Florida, Saint Augustine (1565)
%Hilton visited Florida approx. one hundred years later "the country abounds with grapes, large figs and peaches" p42 Hedrick believed "abound" may have been exaggeration or not actually describing Florida
%Bartram mentions wild or Indian cultivated peach in accounts of his travels during 1765-1766; "near the Savannah River" Hedrick p42
%Le Page Du Pratz wrote "that the natives had peaches.. when the French settled in Louisiana in 1698" Hedrick p43; also wrote that peaches were planted regularly, about every seven years, from seed becuase "the tree dies irrecoverably" Hedrick p44
%Nice generation time description: "a peach falling to the ground brings a peach tree that shall bear in three years, or sometimes sooner" Hedrick p45 quoting John Lawson (1700)
...
%Lawson's statements also suggest the degree of inbreeding in Indian/American peaches: "we generally rais this fruit from the stone, which never fails to bring the same fruit" Hedrick p46
%second introduction by English at Jamestown 1629 - Hedrick p46
%Beverly wrote in the early 18th century a history of Virginia, in which he states "Peaches and nectarines I believe to be spontaneous, somewhere or other on that continent, for the Indians have, and ever had greater variety and finer sorts of them than the English" Hedrick p49
%Oldmixon in mid-18th century also stated "here is such plenty of peaches that they give them to their hogs; some of them, called malachotoons, are as big as a lemon and resemble it a little". Melocoton being the name of peaches in Mexico and Spain (Hedrick p51)
...
%Anne's library prep
%
% What about QC, such as BioAnalyzer and qPCR, or pooling? 
%
BGI sequenced the four remaining samples, also paired end to 100 bp length, from libraries prepared at their facility.
% State things clearly and briefly in active tense starting with the new data, e.g., "We sequenced...", and then add a paragraph on public samples added. In the we sequenced paragraph you need to provide PE 100, where they were sequenced, what average depth, and a citation for library prep (or if we paid someone to prep libraries)
%
...
determined a mean mapped sequence depth of 10.710, which ranged from 1.138 to 37.358 (supp. Figure \ref{fig:depth}).\\ %should separate out for our sequenced stuff and all else
...
% Likely for most to hold up but replace with results using filtered data
%selected genes
...
Support for DV provided by the McDonald Endowment for UC Davis Plant Sciences for Graduate Student Research Assistantships and the Almond Board of California (ABC; grant HORT16-Aradhya/Ledbetter). Resequencing funded by the ABC (grant HORT16-Aradhya/Ledbetter) and a Henry A. Jastro Research Fellowship. This work used the Vincent J. Coates Genomics Sequencing Laboratory at UC Berkeley, supported by NIH S10 Instrumentation Grants S10RR029668 and S10RR027303.
